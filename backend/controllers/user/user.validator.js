...
const {
  ...
  validateChangePassword,additionalResource
...
exports.verifyForgotPasswordValidator = genericValidator(validateVerifyForgotPassword.allowedParams,validateVerifyForgotPassword.requiredParams);

exports.changePasswordValidator = genericValidator(validateChangePassword.allowedParams,validateChangePassword.requiredParams);

exports.additionalMember = genericValidator(additionalResource.allowedParams, additionalResource.requiredParams);
